...
const TABLE_FIELDS = [
  ...
  {"field_name":"检测线","type":3,"property":{"options":[{"name":"A线","color":0},{"name":"Y线","color":1},{"name":"K线","color":2},{"name":"T线","color":3}]}},
  {"field_name":"品类","type":3,"property":{"options":[{"name":"手机","color":0},{"name":"平板","color":1},{"name":"笔记本","color":2},{"name":"3C","color":3}]}},
  {"field_name":"品牌","type":3,"property":{"options":[]}},
  {"field_name":"机型","type":3,"property":{"options":[]}},
  {"field_name":"渠道","type":3,"property":{"options":[]}},
  ...
  {"field_name":"质检人","type":3,"property":{"options":[]}},
  {"field_name":"工号","type":3,"property":{"options":[]}},
  {"field_name":"质检时间","type":1},
  {"field_name":"质检间隔时间","type":1},
  {"field_name":"质检时效","type":1},
  {"field_name":"分步质检","type":3,"property":{"options":[]}},
  {"field_name":"功能","type":4,"property":{"options":[]}},
  {"field_name":"拆修","type":4,"property":{"options":[]}},
  {"field_name":"边框背板","type":4,"property":{"options":[]}}
];
...
async function syncData() {
  try {
    ...
    for (var rec of records.data) {
      ...
      fields['功能'] = selInfo.gongneng.length ? selInfo.gongneng : [];
      fields['拆修'] = selInfo.caixiu.length ? selInfo.caixiu : [];
      fields['边框背板'] = selInfo.biankuang.length ? selInfo.biankuang : [];
