...
(function() {
    ...
    const JX_URL = 'https://cdn.jsdelivr.net/gh/1593125616-glitch/danghuan@main/jixing.user.js';
    ...
    function checkJxUpdate() {
        ...
        GM_xmlhttpRequest({
            ...
            onerror: function() { jxMarkDone(); },
            ontimeout: function() { jxMarkDone(); }
        });
    }
    checkJxUpdate();
